...
define(['N/record', 'N/ui/serverWidget', 'N/url'],
    ...
    function (record, serverWidget, url) {
        ...
        * Function      : beforeLoad
        * Purpose       : load print down payment button in SO transaction
        * Params
        */
            ...
            try {
                ...
                if (context.type == "view") {
                    const href = url.resolveScript({
                         scriptId: 'customscript_msi_so_pi_downpayment',
                        deploymentId: 'customdeploy_msi_so_pi_dp_deploy',
                        params: {
                          recId: curr.id
