    ...
    const post = (body) => {
        try {
            ...
            if (filtersBody.lastmodified) {
                ...
                // (bukan lewat new Date() + getDate()/getHours()) - getter lokal
                // itu bergantung ke timezone runtime yang gak konsisten, jadi bisa
                // geser tanggal/jam. Asumsi: offset di payload sama dengan
